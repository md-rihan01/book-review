    ...
    <div class="form-card mb-4">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('admin.reviews.index') }}" class="btn-admin-secondary btn-sm flex-fill d-flex align-items-center justify-content-center">Clear</a>
            </div>
            ...
            <table class="admin-data-table">
                <thead>
                    <tr>
                        ...
                        <th><x-sortable-header label="User" sort="user_id" :currentSort="request('sort')" :currentDirection="request('direction')" /></th>
                        <th>Review</th>
                ...
                <tbody>
                    @forelse($reviews as $review)
                        <tr>
                            ...
                            <td class="small">{{ Str::limit($review->book->title, 30) }}</td>
                            ...
                            <td class="actions-column">
                                <div class="action-group" style="justify-content:flex-end;">
                                    <a href="{{ route('admin.reviews.edit', $review) }}" class="action-edit">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <button type="button" class="action-delete"
                                        onclick="confirmDelete('{{ route('admin.reviews.destroy', $review) }}', 'Are you sure you want to delete this review?')">
