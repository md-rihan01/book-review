...
@section('content')
    ...
    <div class="form-card mb-4">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-2">
                <a href="{{ route('admin.books.index') }}" class="btn-admin-secondary btn-sm w-100 d-block text-center">Clear</a>
            </div>
    ...
    <form method="POST" action="{{ route('admin.books.bulk') }}" id="bulk-form">
        @csrf
                ...
                <tbody>
                    @forelse($books as $book)
                        <tr>
                            ...
                            <td class="text-muted small">{{ $book->author?->name ?? 'N/A' }}</td>
                            ...
                            <td class="actions-column">
                                <div class="action-group" style="justify-content:flex-end;">
                                    ...
                                    <a href="{{ route('admin.books.edit', $book) }}" class="action-edit">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <button type="button" class="action-delete"
                                        onclick="confirmDelete('{{ route('admin.books.destroy', $book) }}', 'Are you sure you want to delete &quot;{{ $book->title }}&quot;?')">
